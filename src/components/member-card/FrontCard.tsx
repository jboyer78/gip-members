    ...
    <CardBackground imageUrl="/lovable-uploads/7fabfc2f-74f0-42fe-b42e-d38ff0226691.png">
      <div className="flex flex-col h-full">
        <div className="flex-1 relative">
          <div className="absolute top-[55%] sm:top-[65%] left-10 sm:left-20 space-y-0.5 sm:space-y-1 transform scale-[0.55] sm:scale-90 md:scale-100 origin-top-left">
          ...
          <div className="absolute top-[10.5rem] sm:top-[7.75rem] right-7 sm:right-20 md:right-24 w-12 sm:w-24 md:w-36 h-16 sm:h-32 md:h-44 bg-gray-100 overflow-hidden">
            {profile.avatar_url ? (
              <img 
