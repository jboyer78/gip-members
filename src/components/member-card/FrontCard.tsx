    ...
    <CardBackground imageUrl="/lovable-uploads/7fabfc2f-74f0-42fe-b42e-d38ff0226691.png">
      <div className="flex flex-col h-full">
        <div className="flex-1 relative">
          ...
          <div className="absolute top-[8.5rem] sm:top-[7.75rem] right-8 sm:right-20 md:right-24 w-14 sm:w-24 md:w-36 h-20 sm:h-32 md:h-44 bg-gray-100 overflow-hidden">
            {profile.avatar_url ? (
              <img 
