    ...
    <CardBackground imageUrl="/lovable-uploads/7fabfc2f-74f0-42fe-b42e-d38ff0226691.png">
      <div className="flex flex-col h-full">
        <div className="flex-1 relative">
          ...
          <div className="photo-container absolute top-[12.5rem] sm:top-[11rem] right-9 sm:right-7 w-20 h-24 sm:h-40 md:h-56 bg-gray-100 overflow-hidden sm:w-32 md:w-48 border border-black">
            {profile.avatar_url ? (
              <img 
