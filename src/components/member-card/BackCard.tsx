  ...
  return (
    <CardBackground imageUrl="/lovable-uploads/c22c59c8-c1b1-4a6e-90f6-6039957c2112.png">
      <div className="relative h-full">
        <div className="absolute top-[10%] sm:top-[15%] left-4 sm:left-16 space-y-0.5 sm:space-y-1 transform scale-[0.70] sm:scale-90 md:scale-100 origin-top-left">
        ...
        <div className="absolute top-[10%] sm:top-[15%] right-4 sm:right-12">
          <QRCodeSVG 
            value={publicCardUrl}
            size={117}
            level="H"
